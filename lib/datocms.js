...
import CATERING_PAGE_QUERY from './queries/cateringPage';
import CONTACT_PAGE_QUERY from './queries/contactPage';
...
export const getCateringPage = async (preview) => {
	const data = await request({
		query: CATERING_PAGE_QUERY,
		preview,
	});

	return data?.cateringPage;
};
